...
namespace LightweightPlugins\Firewall\Admin\Hub;
...
final class RegistryFallback {
	...
	public static function get(): array {
		return array(
			'lw-cookie'       => array(
				'name'          => 'LW Cookie',
				'description'   => __( 'GDPR-compliant cookie consent banner.', 'lw-firewall' ),
				'icon_color'    => '#c05621',
			...
			'lw-disable'      => array(
				'name'          => 'LW Disable',
				'description'   => __( 'Disable WordPress features like comments.', 'lw-firewall' ),
				'icon_color'    => '#d63638',
			...
			'lw-enable'       => array(
				'name'          => 'LW Enable',
				'description'   => __( 'Enable WordPress features: SVG uploads and more.', 'lw-firewall' ),
				'icon_color'    => '#2e7d32',
			...
			'lw-firewall'     => array(
				'name'          => 'LW Firewall',
				'description'   => __( 'Rate limiting, bot blocking, IP bans and security headers.', 'lw-firewall' ),
				'icon_color'    => '#6d28d9',
			...
			'lw-img'          => array(
				'name'          => 'LW Img',
				'description'   => __( 'Lightweight image optimization — auto-convert uploads to WebP via HelloImg.', 'lw-firewall' ),
				'icon_color'    => '#00875f',
			...
			'lw-lms'          => array(
				'name'          => 'LW LMS',
				'description'   => __( 'Headless LMS backend: courses, lessons, access, progress and quizzes over a REST API.', 'lw-firewall' ),
				'icon_color'    => '#4a9c5d',
			...
			'lw-pixel'        => array(
				'name'          => 'LW Pixel',
				'description'   => __( 'Tracking pixels: Meta, GA4, Ads, GTM, TikTok, Pinterest, Bing, Reddit, Snapchat, X.', 'lw-firewall' ),
				'icon_color'    => '#2b65f6',
			...
			'lw-scan'         => array(
				'name'          => 'LW Scan',
				'description'   => __( 'Malware scanner for files, the database and vulnerable software.', 'lw-firewall' ),
				'icon_color'    => '#d63638',
			...
			'lw-seo'          => array(
				'name'          => 'LW SEO',
				'description'   => __( 'Essential SEO features without the bloat.', 'lw-firewall' ),
				'icon_color'    => '#2271b1',
			...
			'lw-site-manager' => array(
				...
				'description'   => __( 'Site maintenance via AI/REST using Abilities API.', 'lw-firewall' ),
				'icon_color'    => '#135e96',
			...
			'lw-translate'    => array(
				'name'          => 'LW Translate',
				'description'   => __( 'Manage WordPress translations from community repositories.', 'lw-firewall' ),
				'icon_color'    => '#0073aa',
			...
			'lw-zenadmin'     => array(
				'name'          => 'LW ZenAdmin',
				'description'   => __( 'Clean up your admin — notices sidebar & widget manager.', 'lw-firewall' ),
				'icon_color'    => '#8e44ad',
