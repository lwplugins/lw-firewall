...
final class Page {
	...
	public static function enqueue( $hook ): void {
		...
		wp_set_script_translations( self::HANDLE, 'lw-firewall', plugin_dir_path( Hub::plugin_file() ) . 'languages' );
	...
	public static function render(): void {
		...
		if ( ! Assets::has_build() ) {
			printf(
				...
				esc_html__( 'LW Plugins', 'lw-firewall' ),
				esc_html__( 'The LW Plugins page files are missing. Re-install the plugin from a release ZIP.', 'lw-firewall' )
			);
			return;
		}
