...
final class Catalog {
	...
	public function row( string $slug ): array {
		...
		return array(
			...
			'description' => translate( $entry['description'], 'lw-firewall' ), // phpcs:ignore WordPress.WP.I18n.LowLevelTranslationFunction,WordPress.WP.I18n.NonSingularStringLiteralText -- registry text; the literals are in RegistryFallback.
			'status'      => $state['status'],
