...
final class NoticeManagerTest extends MonkeyTestCase {
	...
	public static function callback_provider(): array {
		return [
			'LW static method string' => [ 'LightweightPlugins\\Firewall\\Admin\\AdminNotice::render', true ],
		...
		$GLOBALS['wp_filter'] = [
			'admin_notices'     => (object) [
				'callbacks' => [
					10 => [
						'a' => [ 'function' => $foreign ],
						'b' => [ 'function' => 'LightweightPlugins\\Firewall\\Admin\\AdminNotice::render' ],
					],
				],
			],
	...
	private function on_lw_page(): void {
		$GLOBALS['plugin_page'] = 'lw-firewall';
