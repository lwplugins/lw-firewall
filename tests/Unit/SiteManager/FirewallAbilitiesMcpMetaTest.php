...
use LightweightPlugins\Firewall\SiteManager\FirewallAbilities;
 ...
 * listed them.
 *
 * @covers \LightweightPlugins\Firewall\SiteManager\FirewallAbilities
 */
final class FirewallAbilitiesMcpMetaTest extends MonkeyTestCase {
